package com.example.divulgeadmin.adapters
...
import com.example.divulgeadmin.databinding.ItemArticlePreviewBinding
...
class NewsRecyclerAdapter : RecyclerView.Adapter<NewsRecyclerAdapter.ArticleViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ArticleViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            tvPublishedCountry.text = article.countryCode
